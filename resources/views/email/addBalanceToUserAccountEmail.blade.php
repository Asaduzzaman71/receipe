...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td style="padding: 30px;">
            <p style="font-family:verdana;font-size:13px;margin:0px;padding-bottom:15px;line-height:normal;">Dear {{$dealsWithUser->user->first_name}} {{$dealsWithUser->user->last_name}}</p>
            <p style="display:block;text-align:center;margin:0px;padding-bottom:25px;line-height:normal;"><button class="button button-green">${{$dealsWithUser->deal->offer_price}} added in your account Balance</button></p>
